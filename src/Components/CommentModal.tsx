                    ...
                    <DialogContent className="border-none bg-[white]">
                        ...
                        <div className="grid gap-4">
                            <div className="grid gap-3">
                                <textarea value={comments} ref={inputRef} onChange={(e) => handleSearchInput(e)} className="w-[100%] m-[auto] h-[10rem] bg-[light-grey] p-[0.6rem] border-[1px] border-[grey] outline-none rounded-[0.4rem]"></textarea>
                            </div>
                        </div>
